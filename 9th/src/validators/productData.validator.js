...
export const productDataValidartor = [
    ...
    .isLength({ min:4}).withMessage("Tiene que tener al menos 4 caracteres")
    ,
    body("description")
    ...
    ,
    body("code")
    .isString().withMessage("El codigo debe ser un texto")
    ...
    .isLength({ min:1}).withMessage("Tiene que tener al menos 1 caracteres")
    ,
    body("status")
    .isBoolean(),
